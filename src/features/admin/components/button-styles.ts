...
const buttonBase = `inline-flex min-h-11 items-center justify-center rounded-[var(--radius-surface)] px-4 py-2.5 text-sm font-medium ${motionButtonClassName} cursor-pointer disabled:cursor-not-allowed disabled:opacity-50`;
...
export const landingButtonBase = `inline-flex h-12 cursor-pointer items-center justify-center rounded-[var(--radius-surface)] px-6 text-base font-medium ${motionButtonClassName}`;
